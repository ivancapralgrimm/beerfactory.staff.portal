...
export function RecipePhotoDialog({
  ...
  return (
    <dialog
      ref={dialogRef}
      className="recipe-photo-dialog m-auto max-h-[92dvh] w-[min(94vw,1100px)] overflow-hidden rounded-2xl border border-[var(--bf-line)] bg-[var(--bf-bg)] p-0 text-[var(--bf-cream)]"
